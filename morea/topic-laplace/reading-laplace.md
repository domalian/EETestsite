...
* Since differential equations represent a RLC circuit in the time doamin , the Laplace Transform is a powerful tool that allow us to use algebraic operations to analyze the circuit.
...
<div align="center">$$F(s)=$$&#8466; $${[f(t)]}= \int_{0}^{\infty} f(t)e^{-st} \; dt$$  

Where $$s$$ is a complex variable with a real part $$\sigma$$  and an imaginary part $$\omega$$ </div>
$$$$s=\sigma+j\omega$$$$
...
<div align="center">&#8466; $${(e^t)}= \int_{0}^{\infty} e^te^{-st} \; dt$$</div>
...
<div align="center">&#8466; $${[C*f(t)]}=$$$$C*$$&#8466; $${[f(t)]}$$</div>
* Addition
 ### <div align="center">&#8466; $${[f(t)+g(t)]}=$$&#8466; $${[f(t)]}+$$&#8466; $${[g(t)]}$$</div>
  * ### In general
   ### <div align="center">&#8466; $${[C*f(t)+D*g(t)]}=$$$$C*$$&#8466; $$[f(t)]+D*$$&#8466; $${[g(t)]}$$</div>
...
### Example 6:
<center><img src="https://github.com/sgtpepper61/EE/blob/main/lapace5.png?raw=true"> </center>  

### <div align="center">$$f(t)={2u(t)+2u(t-1)-4u(t-2)}$$ </div>

### <div align="center">$$F(S)=\frac{2}{s}+\frac{2e^{-s}}{s}-\frac{4e^{-s}}{s}$$ </div>
### Example 7:
<center><img src="https://github.com/sgtpepper61/EE/blob/main/Laplace6.png?raw=true"> </center>  
...
<center><img src="https://github.com/sgtpepper61/EE/blob/main/Laplace7.png?raw=true"> </center>
